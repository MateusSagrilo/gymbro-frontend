...
import type { GetHomeData200ConsistencyByDay, GetHomeData200TodayWorkoutDay } from "@/app/_lib/api/fetch-generated";
...
export type HomeContentPayload =
  ...
  | {
      ...
      userName: string;
      todayStr: string;
      todayWorkoutDay: GetHomeData200TodayWorkoutDay | undefined;
      workoutStreak: number;
      consistencyByDay: GetHomeData200ConsistencyByDay;
    };

export function HomeContent({ payload }: { payload: HomeContentPayload }) {
